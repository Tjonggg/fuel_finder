...
import '../services/storage_provider/storage_manager.dart' as _i6; // ignore_for_file: unnecessary_lambdas
...
_i1.GetIt $initGetIt(_i1.GetIt get, {String? environment, _i2.EnvironmentFilter? environmentFilter}) {
  ...
  gh.factory<_i4.LocationBloc>(() => _i4.LocationBloc(geolocator: get<_i5.GeolocatorWrapper>()));
